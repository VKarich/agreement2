...
export { default as Requisites } from '../../components/Requisites.vue'
export { default as Sides } from '../../components/Sides.vue'
...
export const LazyRequisites = import('../../components/Requisites.vue' /* webpackChunkName: "components/requisites" */).then(c => wrapFunctional(c.default || c))
export const LazySides = import('../../components/Sides.vue' /* webpackChunkName: "components/sides" */).then(c => wrapFunctional(c.default || c))
