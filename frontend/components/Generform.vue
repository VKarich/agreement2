<template>
  <div class="second_selection">
    <div
      id="sec_" v-if="select_first_step"
    >
      <div id="left_menu">
        <form-builder
          :model="model"
          :schema_test="schema_test"
          :select_first_step="select_first_step"
      ...
      <div id="right_menu" v-if="select_first_step == 'Договор купли-продажи недвижимого имущества'">
        <dkp
          :model="model"
          :select_second_step="select_second_step"
          :select_third_step="select_third_step"
...
import flSeller_out from "../../schema/fl.json";
import ulSeller_out from "../../schema/ul.json";
...
export default {
  ...
  beforeUpdate() {
    ...
    // }
    this.model.select_first_step = this.select_first_step;

    // let list = mainInfo[0].fields.concat(flSeller_1.fields).concat(flSeller_2.fields).concat(ulSeller_1.fields).concat(ulSeller_2.fields).concat(flBuyer_1.fields).concat(flBuyer_2.fields).concat(ulBuyer_1.fields).concat(ulBuyer_2.fields).concat(mainObject[0].fields).concat(mainPayment[0].fields);
    // for (let n in list) {
    //   this.model[list[n].model] = list[n].model
    // }
